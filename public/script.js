async function getData() {
  ...
  try {
    ...
    // Handle avatar URL, default image if missing
    document.getElementById("avatar").src = data.avatar_url || 'default-avatar.jpg';
    document.getElementById("name").textContent = data.name || username;
    document.getElementById("repos").textContent = data.repos || 'N/A';
    document.getElementById("xp").textContent = data.xp || '0';
    document.getElementById("level").textContent = data.level || '1';
    document.getElementById("badge").textContent = getBadge(data.level); 
